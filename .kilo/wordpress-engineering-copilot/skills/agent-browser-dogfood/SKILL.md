...
description: "use for exploratory webapp qa, dogfooding, bug hunts, acceptance testing, ux checks, runtime audits, console or network investigation, screenshots, and issue-quality reproduction reports using agent-browser. trigger when the user asks to test, review, inspect, break, verify, or quality-check a website or web application."
---
